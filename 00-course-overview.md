...
> 版本：v1.1　|　適用環境：Proxmox VE 9.x　|　Kubernetes 1.36/1.37
> 每堂課 **1 ~ 1.5 小時**（Class 2 含 OCP 比較，約 1 hr 40），共 7 堂課（理論＋實作）。
...
| 1 | Proxmox VE 虛擬化平台概論（9.x 最新版） | 1.25 hr | 理論＋實作 |
| 2 | Kubernetes 核心架構與運作原理（含 K8s vs OpenShift 比較） | 1.5–1.7 hr | 理論 |
